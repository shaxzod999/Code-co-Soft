            ...
            <div className="col-xl-3 col-lg-2 col-5">
              <div className="site_logo">
                <Link onClick={ClickHandler} className="site_link" to="/">
                  <img
                    src={logo}
                    alt="Site Logo – Code-co Soft – IT Solutions & Technology, Business Consulting, Software Company Site Template"
                  />
                  <img
                    src={logo2}
                    alt="Site Logo – Code-co Soft – IT Solutions & Technology, Business Consulting, Software Company Site Template"
